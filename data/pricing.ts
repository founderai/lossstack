...
export const unifiedPlans: UnifiedPlan[] = [
  {
    ...
    features: [
      ...
      { text: "3 one-time report credits", included: true },
      { text: "Basic ImageLablr usage", included: true },
      { text: "Limited exports", included: true },
      { text: "No integrations", included: false },
      { text: "Storage persistence", included: false },
    ],
  },
  {
    id: "core",
    ...
    features: [
      ...
      { text: "Standard features unlocked", included: true },
      { text: "Cross-app integrations", included: true },
      { text: "Standard processing speed", included: true },
      { text: "$14.99/report", included: true },
      { text: "Storage (add-on: +$49/mo)", included: false },
    ],
  },
  {
    id: "pro",
    ...
    features: [
      ...
      { text: "10 report credits/month", included: true },
      { text: "$12.99/report after credits", included: true },
      { text: "Storage included", included: true },
      { text: "Priority processing", included: true },
      { text: "Bulk workflows", included: true },
    ],
  },
  {
    id: "firm",
    ...
    features: [
      ...
      { text: "25 report credits/month", included: true },
      { text: "$9.99/report after credits", included: true },
      { text: "Team workspace", included: true },
      { text: "Shared cases & files", included: true },
